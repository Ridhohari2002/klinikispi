<?php
    $klinikkk = "Klinik Apotek Ispi Medika";
    $mappp = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.306326701897!2d104.6884698!3d-3.0120726!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e3b9f141e56e75b%3A0xfd0a50c1f7a6e272!2sKlinik%20Apotek%20Ispi%20Medika!5e0!3m2!1sen!2sid!4v1741156108682!5m2!1sen!2sid";
?>
...
<head>
    ...
    <link href="{{ asset('img/faviconispi.ico') }}" rel="SHORTCUT ICON" />
</head>
...
<!-- Navigation-->
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"> <img src="{{ asset('img/ispimedika.jpeg') }}" style="float: left; width:55px; height:55px; border-radius:50%;" alt="Logo Klinik"><span style="margin-left: 10px;">KLINIK</span></a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="{{ asset('img/ispimedika.jpeg') }}" alt="Logo Klinik" style="width:150px; height:150px; border-radius:50%;" />
            <!-- Masthead Heading-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Gandus Palembang</p>
        </div>
    </header>
    <!--------------------------------------------------------Bagian Isi Konten----------------------------------------------------------------------------------->
    ...
    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
        ...
        <img class="img-fluid portfolio-image" src="img/dalam2.jpg" alt="Foto Dalam 2" />
    </div>
</div>
                <!-- Portfolio Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
        ...
        <img class="img-fluid portfolio-image" src="img/dalam1.jpg" alt="Foto Dalam 1" />
    </div>
</div>
                <!-- Portfolio Item 3-->
                <div class="col-md-6 col-lg-4 mb-5">
    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
        ...
        <img class="img-fluid portfolio-image" src="img/luar1.jpg" alt="Foto Luar 1" />
    </div>
</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                    Jl. TPH Sopian Kenawas, RT.016/RW.005, Gandus
                        <br />
                ...
                <div class="col-lg-4">
                    ...
                    <p class="lead mb-0">
                        Klinik {{ env('APP_NAME') }} dibangun sejak tahun 2025 yang berada di Jl. TPH Sopian Kenawas, RT.016/RW.005, Gandus, Kec. Gandus, Kota Palembang, Sumatera Selatan 30149
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="form-group row mt-2">
                ...
                <div class="col-sm">
                    <select name="doktor" class="form-control " required
                        ...
                        <option {{ optional($row->jadwal)->jadwalpraktek == 'LIBUR' ? 'disabled' : ''}} {{ optional($row->jadwal)->jadwalpraktek == 'CUTI' ? 'disabled' : ''}} value="{{ $row->id }}">
                                {{ $row->nama }}({{ $row->poli == '' ? '-' : $row->poli->name }}) |
                                {{ $row->jadwal == '' ? 'Belum ada Jadwal' : optional($row->jadwal)->jadwalpraktek }}
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            <img src="{{ asset('img/faviconispi.ico') }}" style=”float:left;
                                width="55";height="55";border-radius="50%"” />Klinik {{ env('APP_NAME') }}
                        </h5>
