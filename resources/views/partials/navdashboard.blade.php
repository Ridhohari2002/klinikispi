    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <img class="sidebar-card-illustration mb-2" src="img/faviconispi.ico" alt="..." style="width: 55px; height: 55px; border-radius: 50%;">
            ...
            <div class="sidebar-heading">
                Powered by &copy; KLINIK {{ env("APP_NAME") }} <br>2025
            </div>
