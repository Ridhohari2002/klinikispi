...
<body id="page-top" onload="initClock()">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="/#page-top"><img src="{{ asset('img/ispimedika.jpeg') }}" style="float: left; width:55px; height:55px; border-radius:50%;" alt="Logo Klinik"><span style="margin-left: 10px;">KLINIK</span> {{ env('APP_NAME') }}</a>
